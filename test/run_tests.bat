...
@set CMD_CONSTRUCT_WORKSPACE=cconstruct.exe --generate-projects
@set CMD_BUILD=msbuild /p:Configuration=Debug /p:Platform=x64 /v:minimal build\workspace.sln
@set BUILD_RELEASE_COMMAND=msbuild /p:Configuration=Release /p:Platform=x64 /v:minimal build\workspace.sln
...
%COMPILE_CONSTRUCT_COMMAND% config.cc || exit /b
%CMD_CONSTRUCT_WORKSPACE% || exit /b
msbuild build\workspace.sln /t:my_library /p:Configuration=Debug;Platform=x64 || exit /b
msbuild build\workspace.sln /t:my_binary /p:Configuration=Debug;Platform=x64 || exit /b
msbuild build\workspace.sln /t:my_library /p:Configuration=Debug;Platform=x86 || exit /b
msbuild build\workspace.sln /t:my_binary /p:Configuration=Debug;Platform=x86 || exit /b
msbuild build\workspace.sln /t:my_library /p:Configuration=Release;Platform=x64 || exit /b
msbuild build\workspace.sln /t:my_binary /p:Configuration=Release;Platform=x64 || exit /b
msbuild build\workspace.sln /t:my_library /p:Configuration=Release;Platform=x86 || exit /b
msbuild build\workspace.sln /t:my_binary /p:Configuration=Release;Platform=x86 || exit /b
...
%COMPILE_CONSTRUCT_COMMAND% config.cc || exit /b
%CMD_CONSTRUCT_WORKSPACE% || exit /b
msbuild /p:Configuration=Debug /p:Platform=x64 /v:minimal build\project_structure.sln || exit /b
build\x64\Debug\my_binary.exe || exit /b
@popd
...
pushd build
%CMD_CONSTRUCT_WORKSPACE% || exit /b
msbuild /p:Configuration=Debug /p:Platform=x64 /v:minimal workspace.sln || exit /b
