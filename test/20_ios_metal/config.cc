...
int main(int argc, const char** argv) {
  ...
  cc_architecture_t platform   = cc.createPlatform(EPlatformPhone);
  cc_configuration_t c_debug   = cc.createConfiguration("Debug");
  cc_configuration_t c_release = cc.createConfiguration("Release");
  ...
  cc_project_t p = cc.createProject("TestGame", CCProjectTypeWindowedApplication, NULL);
